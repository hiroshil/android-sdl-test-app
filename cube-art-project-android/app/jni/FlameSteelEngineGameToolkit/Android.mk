...
LOCAL_MODULE := FlameSteelEngineGameToolkit
LOCAL_C_INCLUDES := $(LOCAL_PATH)/src $(LOCAL_PATH)/include $(LOCAL_PATH)/../include $(LOCAL_PATH)/../include/FlameSteelCommonTraits/src/FlameSteelCommonTraits
